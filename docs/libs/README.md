...
### E
  ...
  * **[expat: libexpat (libexpat.so) 2.7.4](expat.md)<a id='expat'></a>**<br>
...
### H
  ...
  * **[HarfBuzz (libharfbuzz.so) 12.3.2](harfbuzz.md)<a id='harfbuzz'></a>**<br>
...
### L
  ...
  * **[libpng: PNG library (libpng.so) 1.6.55](libpng.md)<a id='libpng'></a>**<br>
...
### U
  ...
  * **[uClibc (ld-uClibc-x.y.z.so) 0.9.28/0.9.29/0.9.32.1/0.9.33.2/1.0.14/1.0.56](uclibc.md)<a id='uclibc'></a>**<br>

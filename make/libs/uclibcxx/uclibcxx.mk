...
$(PKG)_SITE:=https://git.uclibc.org/uClibc++/snapshot
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_LIB_libuClibcxx_WITH_WCHAR
...
$($(PKG)_DIR)/.configured: $($(PKG)_DIR)/.unpacked
	...
	$(call PKG_EDIT_CONFIG, \
		UCLIBCXX_HAS_WCHAR=$(FREETZ_LIB_libuClibcxx_WITH_WCHAR) \
		UCLIBCXX_SUPPORT_WCIN=$(FREETZ_LIB_libuClibcxx_WITH_WCHAR) \
		UCLIBCXX_SUPPORT_WCOUT=$(FREETZ_LIB_libuClibcxx_WITH_WCHAR) \
		UCLIBCXX_SUPPORT_WCERR=$(FREETZ_LIB_libuClibcxx_WITH_WCHAR) \
	) $(UCLIBCXX_DIR)/.config
	touch $@

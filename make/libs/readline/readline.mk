$(call PKG_INIT_LIB, $(if $(FREETZ_LIB_libreadline_WITH_VERSION_ABANDON),6.3,8.3))
...
$(PKG)_HASH:=$($(PKG)_HASH_$(if $(FREETZ_LIB_libreadline_WITH_VERSION_ABANDON),ABANDON,CURRENT))
$(PKG)_SITE:=@GNU/$(pkg)
### VERSION:=6.3-p8/8.3
...
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_LIB_libreadline_WITH_VERSION_ABANDON),abandon,current)

$(call PKG_INIT_LIB, $(if $(FREETZ_LIB_libusb_1_WITH_VERSION_ABANDON),1.0.23,1.0.30))
$(PKG)_SHORT_VERSION:=$(call GET_MAJOR_VERSION,$($(PKG)_VERSION))
$(PKG)_LIB_VERSION:=$(if $(FREETZ_LIB_libusb_1_WITH_VERSION_ABANDON),0.2.0,0.6.0)
...
$(PKG)_HASH:=$($(PKG)_HASH_$(if $(FREETZ_LIB_libusb_1_WITH_VERSION_ABANDON),ABANDON,CURRENT))

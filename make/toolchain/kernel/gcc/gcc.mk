...
GCC_KERNEL_MAJOR_VERSION:=$(call GET_MAJOR_VERSION,$(GCC_KERNEL_VERSION),2)
...
GCC_KERNEL_HASH_8.4.0  := e30a6e52d10e1f27ed55104ad233c30bd1e99cfb5ff98ab022dc941edd1b2dd4
GCC_KERNEL_HASH_9.3.0  := 71e197867611f6054aa1119b13a0c0abac12834765fe2d81f35ac57f84f742d1
GCC_KERNEL_HASH_9.4.0  := c95da32f440378d7751dd95533186f7fc05ceb4fb65eb5b85234e6299eb9838e
GCC_KERNEL_HASH_10.5.0 := 25109543fdf46f397c347b5d8b7a2c7e5694a5a51cce4b9c6e1ea8a71ca307c1
GCC_KERNEL_HASH_13.3.0 := 0845e9621c9543a13f484e94584a49ffc0129970e9914624235fc1d061a0c083
GCC_KERNEL_HASH:=$(GCC_KERNEL_HASH_$(GCC_KERNEL_VERSION))

GCC_KERNEL_DIR:=$(KERNEL_TOOLCHAIN_DIR)/gcc-$(GCC_KERNEL_VERSION)
GCC_KERNEL_MAKE_DIR:=$(MAKE_DIR)/toolchain/kernel/gcc
...
$(GCC_KERNEL_DIR)/.unpacked: $(DL_DIR)/$(GCC_KERNEL_SOURCE) | $(KERNEL_TOOLCHAIN_DIR) $(UNPACK_TARBALL_PREREQUISITES)
	@$(call _ECHO,preparing,$(GCC_KERNEL_ECHO_TYPE),$(GCC_KERNEL_ECHO_MAKE))
	$(RM) -r $(GCC_KERNEL_DIR)
	$(call UNPACK_TARBALL,$(DL_DIR)/$(GCC_KERNEL_SOURCE),$(KERNEL_TOOLCHAIN_DIR))
	$(call APPLY_PATCHES,$(GCC_KERNEL_MAKE_DIR)/patches/$(GCC_KERNEL_MAJOR_VERSION),$(GCC_KERNEL_DIR))
	touch $@

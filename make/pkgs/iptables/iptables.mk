$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL2),1.4.11.1,$(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL3),1.4.21,$(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL4),1.6.2,1.8.13))))
...
$(PKG)_HASH_KERNEL5:=1afcd33da9e8f913ace6a2126788162e207e26f5d5e29c6573c0e581ffc58b99

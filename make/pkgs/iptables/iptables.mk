$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL2),1.4.11.1,$(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL3),1.4.21,$(if $(FREETZ_PACKAGE_IPTABLES_VERSION_KERNEL4),1.6.2,1.8.12))))
...
$(PKG)_HASH_KERNEL5:=8e7ee962601492de6503d171d4a948092ab18f89f111de72e3037c1f40cfb846

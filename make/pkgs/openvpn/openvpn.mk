$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.11,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_26),2.6.22,2.7.7))))
...
$(PKG)_HASH_27:=3ab8f48fd6c26d49ba2333a092433949afdb5c85c0e6a1ff265784fbc04a2463

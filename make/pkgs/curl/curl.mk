$(call PKG_INIT_BIN, $(if $(FREETZ_LIB_libcurl_WITH_VERSION_ABANDON),8.12.1,8.19.0))
$(PKG)_LIB_VERSION:=4.8.0
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.xz
$(PKG)_HASH_ABANDON:=0341f1ed97a26c811abaebd37d62b833956792b7607ea3f15d001613c76de202
$(PKG)_HASH_CURRENT:=4eb41489790d19e190d7ac7e18e82857cdd68af8f4e66b292ced562d333f11df

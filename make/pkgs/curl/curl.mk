$(call PKG_INIT_BIN, $(if $(FREETZ_LIB_libcurl_WITH_VERSION_ABANDON),8.12.1,8.18.0))
$(PKG)_LIB_VERSION:=4.8.0
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.xz
$(PKG)_HASH_ABANDON:=0341f1ed97a26c811abaebd37d62b833956792b7607ea3f15d001613c76de202
$(PKG)_HASH_CURRENT:=40df79166e74aa20149365e11ee4c798a46ad57c34e4f68fd13100e2c9a91946

...
$(PKG)_MAKE_OPTIONS += CFLAGS="$(TARGET_CFLAGS) -I$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
$(PKG)_MAKE_OPTIONS += LDFLAGS="$(TARGET_LDFLAGS) -L$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/lib"
...
$(PKG)_MAKE_OPTIONS += WITH_CJSON=yes
$(PKG)_MAKE_OPTIONS += WITH_EDITLINE=no
$(PKG)_MAKE_OPTIONS += WITH_HTTP_API=no
$(PKG)_MAKE_OPTIONS += WITH_WEBSOCKETS=no
$(PKG)_MAKE_OPTIONS += WITH_SQLITE=no

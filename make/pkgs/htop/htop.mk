$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_HTOP_VERSION_ABANDON),1.0.3,3.5.1))
...
$(PKG)_HASH_CURRENT:=526cecd62870aa8d14d2a79a35ea197e4e2b5317d275b567cee0574b2ddb2e9a

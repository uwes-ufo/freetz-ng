$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_PHP_VERSION_56),5.6.40,$(if $(FREETZ_PACKAGE_PHP_VERSION_82),8.2.33,$(if $(FREETZ_PACKAGE_PHP_VERSION_83),8.3.35,$(if $(FREETZ_PACKAGE_PHP_VERSION_84),8.4.26,8.5.11)))))
...
$(PKG)_HASH_8.3:=ff4630fbbbd94359134b7d3c223db59329905bdc4f5a9ef93d257b48e358619a
$(PKG)_HASH_8.4:=32a2de53862ad44ed4a5005244ce4f1b50c271e74dced215449a4443b40569f1
$(PKG)_HASH_8.5:=d9be75c08e8c316f4c8f4194d8fbe1750a15f6a6d9d4e3fe72082abeeb800360

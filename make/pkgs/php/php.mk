$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_PHP_VERSION_56),5.6.40,$(if $(FREETZ_PACKAGE_PHP_VERSION_82),8.2.32,$(if $(FREETZ_PACKAGE_PHP_VERSION_83),8.3.32,$(if $(FREETZ_PACKAGE_PHP_VERSION_84),8.4.23,8.5.9)))))

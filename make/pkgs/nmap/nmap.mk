$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_NMAP_VERSION_4),4.76,$(if $(FREETZ_PACKAGE_NMAP_VERSION_5),5.51,7.98)))
...
$(PKG)_HASH_7:=ce847313eaae9e5c9f21708e42d2ab7b56c7e0eb8803729a3092f58886d897e6
...
ifeq ($(strip $(FREETZ_PACKAGE_NMAP_VERSION_7)),y)

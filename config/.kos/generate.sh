...
SYMS="
 ...
 PPP_ASYNC PPP_DEFLATE PPP PPP_MPPE PPP_MPPE_MPPC PPPOE PPPOL2TP
 ...
 INPUT HID HID_GENERIC USB_HID
 
 EXT2_FS EXT3_FS JBD EXT4_FS EXT4_USE_FOR_EXT23 CRC16 JBD2 FS_MBCACHE
  FAT_FS VFAT_FS HFS_FS HFSPLUS_FS ISO9660_FS JFFS2_FS MINI_FO MINIX_FS MSDOS_FS REISERFS_FS UDF_FS CRC_ITU_T UNION_FS
  ANTFS_FS
